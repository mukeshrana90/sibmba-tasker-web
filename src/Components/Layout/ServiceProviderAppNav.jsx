            ...
            <div className="avatar-menu" role="menu">
              <div className="am-head">
                ...
                <div className="am-meta">
                  <b>{customerDetails?.full_name || "Provider"}</b>
              ...
              <div className="am-item">
                ...
                <button
                  type="button"
                  className={`toggle${isNotificationsEnabled ? " on" : ""}`}
                  role="switch"
              ...
              <Link to="/payment" className="am-item" role="menuitem" onClick={() => setAvatarOpen(false)}>
