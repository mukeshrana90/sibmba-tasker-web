...
export default function UserBookingDetails() {
  ...
  console.log(typeof bookingState?.status, "xxxxxx")
  ...
  console.log("bookingState33", bookingState);
      ...
      return (
        <div className="comman-small-pop">
          ...
          <div className="comman-pop-action">
            <button className="btn-fill w-100" onClick={handleSubmitFeedback}>Submit Feedback</button>
          </div>
        </div>
      );
    }
    ...
    if (showThankYou) {
      return (
        <div className="comman-small-pop">
          ...
          <div className="comman-pop-action">
            <button className="btn-fill" onClick={handleThankYouClose}>Done</button>
          </div>
        </div>
      );
    }
            ...
            <Col lg={12}>
              ...
              <div className="booking-detail-card pt-3">
                ...
                <div>
                  ...
                  {bookingState?.payment?.status !== "paid" ? bookingState?.status == "3" || bookingState?.status == "5" ?
                    ...
                    <div className="book-service-action-btn">
                      ...
                      >Edit</button>}
                      {bookingState?.status == "2" && <button type="button"
                        onClick={() => {
                    ...
                    <button className="feedback-btn" onClick={handleFeedbackOpen}>Give Feedback</button>
                    <button className="book-btn" onClick={() => navigate("/services")}>Book Again</button>
                  </div>}
                </div>
              </div>
            </Col>
          ...
          <div className="booking-status-txt pt-0">
            <div className="booking-status-left-txt">
             ...
             : <p>{`Service provider has ${bookingState?.status === 1 ? `not accepted` : "accepted"}  your booking.`}</p>
              ...
              {bookingState?.status === 3 ? (
                ...
                <p>{`Service provider has ${bookingState?.status === 1 ? `not accepted` : "completed"} your booking.`}</p>
              )}

              <h4>{`${bookingState?.slotTime}, ${moment(bookingState?.date).format(
                "DD MMM"
              )}`} </h4>
            </div>
            ...
            {bookingState?.rescheduledBy && (
              <div className="status-service-provider ">
                ...
                <hr />
                <h5>
                  {`${bookingState?.slotTime}, ${moment(bookingState?.date).format(
                    "DD MMM"
                  )}`}
        ...
        <Modal.Body>
          <div className="comman-small-pop">
            ...
            <div className="comman-pop-action-double">
              ...
              <button onClick={() => handleClose()} className="btn-fill">No</button>
            </div>
          </div>
        </Modal.Body>
      </Modal>
